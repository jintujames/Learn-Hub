...
const {courseDetails}=useSelector((state:any)=>state.course)
  ...
  return (
    ...
    <>
    {showVideoModal && (
        <VideoPlayer videoUrl={currentVideoUrl} setShowVideoModal={setShowVideoModal} setCurrentVideoUrl={setCurrentVideoUrl} />
      )}
          ...
          <div className="w-[1000] flex-1 rounded-md shadow-md border border-[#d7d5d1] bg-[#f3f2f0] mb-2 p-4 h-[22rem]">
            ...
            <div className="w-[100%] p-5 flex  justify-between flex-2 h-[5rem]">
              ...
              <div className="flex    justify-between w-[10rem]">
                ...
                <div  className="w-[100%] " >
                  <button 
                  onClick={() => handleUrl(courseDetails.courseLessons[0].video)}
  ...
  <>
    {courseDetails.courseLessons.map((lesson: any, index: number) => (
      <div key={index} className="w-[1000] flex-1 rounded-md shadow-md border border-[#d7d5d1] bg-[#f3f2f0] mb-2 p-4 h-[7rem]">
        ...
        {/* <div className="w-[70%] h-[48rem] p-1  flex-auto mb-3  rounded-md shadow-md bg-white"> */}
            <div className="col-span-2 h-[18rem] p-5 pt-4 overflow-auto shadow-xl  rounded-xl bg-gray-100 row-span-7 col-start-4">
              <span className="text-xl font-bold">{courseDetails.courseName}</span>
              <h1 className="mt-3 text-stone-500">{courseDetails.courseDescription}</h1>
              <div className="mt-4   flex-auto">
                <span className="font-bold">Category : {courseDetails.category}</span>
              ...
              <h1 className="mt-3 text-stone-500">$: {courseDetails.coursefee}</h1>
