...
import { verifyOTP } from '../../../utils/config/axios.Methode.post'
...
function Otp() {
    ...
    <div className="flex flex-wrap min-h-screen w-full content-center justify-center bg-white">
      ...
      <div className="flex shadow-md">
        ...
        >
          <div className="w-72">
            {/* Heading */}
            <h1 className="text-xl text-center font-semibold">Otp Verify</h1>
  ...
  <div className="mb-3">
    <button type='submit' className="mb-1.5 block w-full text-center text-white bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% hover:bg-gradient-to-r hover:from-indigo-700 hover:via-sky-700 hover:to-emerald-700 px-2 py-1.5 rounded-md">
      Send
    </button>
